  ...
  return (
    <Container fluid className="Service-List">
      ...
      <Container>
        ...
        <p>&nbsp;</p>
        <p>
          El presente Política de Privacidad establece los términos en que Enjoy
          usa y protege la información que es proporcionada por sus usuarios al
          momento de utilizar su sitio web. Esta compañía está comprometida con
        ...
        <p>
          Enjoy está altamente comprometido para cumplir con el compromiso de
        ...
        <p>
          ...
          <a href="https://recargalebara.es" target="_blank">
            visitas a una web{" "}
          </a>
        ...
        <p>
          Enjoy Se reserva el derecho de cambiar los términos de la presente
